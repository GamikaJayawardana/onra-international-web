            ...
            <div className="w-full md:w-[40%] bg-primary text-white p-10 md:p-14 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-red-100 leading-relaxed mb-12">
                  Take the first step towards your global future. Fill out the
                  form and our expert counselors will analyze your profile for
                  free.
                </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-100">
                        25/A, Bolapanlindawaththa, Dewalayagawa, Ratnapura.
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative z-10 mt-12">
                <h5 className="font-bold opacity-80 mb-4 text-sm">
