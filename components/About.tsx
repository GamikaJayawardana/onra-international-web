    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <h6 className="text-primary font-bold tracking-widest uppercase mb-4 text-xs md:text-sm">
              Who We Are
            </h6>
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-10">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex-1 hover:shadow-lg transition-shadow duration-300">
                ...
                <h4 className="font-bold text-secondary mb-2 text-lg">
                  Our Vision
                </h4>
                <p className="text-sm text-gray-500 leading-relaxed">
                  To be the most trusted global education partner, creating
                  pathways for students to achieve their full potential.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex-1 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  Providing transparent, ethical, and personalized counseling to
                  simplify the international migration process.
                </p>
              </div>
            </div>
