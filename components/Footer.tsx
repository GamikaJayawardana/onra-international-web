    ...
    <footer className="bg-secondary text-gray-400 font-sans pt-20 pb-10 border-t border-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 text-center md:text-left">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
              ...
              We help you build a global future with integrity, transparency,
              and expert guidance.
            </p>
            <div className="flex justify-center md:justify-start gap-3 pt-2">
              <a
                href="https://www.facebook.com/share/1HCZdeM1wv/?mibextid=wwXIfr"
                className="w-9 h-9 bg-gray-800 text-gray-300 rounded-lg flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300"
              >
                <FaFacebookF size={14} />
              </a>
              <a
          ...
          <div>
            ...
            <p className="text-sm mb-6 leading-relaxed">
              Subscribe to our newsletter for the latest visa updates and
              scholarship news.
            </p>
            <form className="space-y-3">
              ...
              <button
                type="button"
                className="w-full bg-primary hover:bg-red-700 text-white font-bold py-3 rounded-lg text-sm transition-all shadow-lg shadow-red-500/20 flex items-center justify-center gap-2"
              >
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          <p>
            &copy; {new Date().getFullYear()} Onra International PVT LTD. All
            Rights Reserved.
          </p>
